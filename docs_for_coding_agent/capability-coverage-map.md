...
| CAP-SDK-006 Exec Sessions | `help/08-architecture-internals.cn.md`（runtime server） | `packages/skills-runtime-sdk-python/src/skills_runtime/runtime/server.py` | `docs_for_coding_agent/examples/step_by_step/05_exec_sessions_across_processes/` | `packages/skills-runtime-sdk-python/tests/test_tools_exec_sessions_*` |
| CAP-SDK-007 Collab | `help/06-tools-and-safety.cn.md`（collab tools） | `packages/skills-runtime-sdk-python/src/skills_runtime/tools/builtin/spawn_agent.py` | `docs_for_coding_agent/examples/step_by_step/06_collab_across_processes/` | `packages/skills-runtime-sdk-python/tests/test_tools_collab_*` |
