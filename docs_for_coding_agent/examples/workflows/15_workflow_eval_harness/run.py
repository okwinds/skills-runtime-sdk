...
WORKFLOWS: Dict[str, str] = {
    "04": "docs_for_coding_agent/examples/workflows/04_map_reduce_parallel_subagents/run.py",
    "05": "docs_for_coding_agent/examples/workflows/05_multi_agent_code_review_fix_qa_report/run.py",
}
