...
```bash
python3 examples/workflows/09_branching_router_workflow/run.py --workspace-root /tmp/srsdk-demo
```

选择分支（默认 A）：

```bash
python3 examples/workflows/09_branching_router_workflow/run.py --workspace-root /tmp/srsdk-demo --route B
```
